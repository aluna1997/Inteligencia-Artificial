...
public class Termitas extends PApplet {
    ...
    public void setup() {
        ...
        //Preprocesamiento  de esta manera agilizamos el movimiento de las termitas,
        //para ver un resultado más temprano.
    ...
    class ModeloTermitas{
      ...
      */
      int direccionAleatoriaFrente(int direccion){
        ...
        switch(direccion) {
            case 0:
                int[] posibles = {7,0,1};
                return posibles[rnd.nextInt(3)];
            case 1:
                return (int)(rnd.nextDouble() * 3 + 0);
            case 2:
                return (int)(rnd.nextDouble() * 4 + 1);
            case 3:
                return (int)(rnd.nextDouble() * 5 + 2);
            case 4:
                return (int)(rnd.nextDouble() * 6 + 3);
            case 5:
                return (int)(rnd.nextDouble() * 7 + 4);
            case 6:
                return (int)(rnd.nextDouble() * 8 + 5);
            case 7:
                int[] posiblesd = {6,7,0};
                return posiblesd[rnd.nextInt(3)];     
        }
      ...
      */
      void dejarAstillaConSalto(Termita t){
        ...
        int auxY = 0;
        do{
            auxX = rnd.nextInt(149);
            auxY = rnd.nextInt(99);
        
        }while(mundo[auxY][auxX].estado == true);
